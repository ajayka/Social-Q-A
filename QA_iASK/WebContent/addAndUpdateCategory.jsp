...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="AdminProfile.jsp"><span	data-hover="My Profile">My Profile</span></a></li>
	...
	<div class="banner-w3agile">
		<div class="container">
			<h3>
				<a href="#index.jsp">Home</a> / <span>Insert New Category</span>
			</h3>
		</div>
	</div>
	<br></br>
	<center>
		...
		<form action="addNewSubCategory" method="post">
		<input type="text" name="catName" placeholder="Add New Category">
