...
<!--header-->
	...
	<!--header-->
		<div class="banner-w3agile">
			<div class="container">
				<h3><a href="#Home.jsp">Home</a> / <span>My Profile</span></h3>
			</div>
		</div>
		
		<center>
		<h3><%=communityInfomation.getFname()+" "+communityInfomation.getLname() %></h3><br>
		<h3><%=communityInfomation.getEmail() %></h3><br>
		</center>
