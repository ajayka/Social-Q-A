...
UserDetails communityInfomation= DataAceesLayer.getDetailsForAdmin(adminID);
...
%>
	...
	<br>
	<table border="solid" align="center" class="table table-striped table-bordered bootstrap-datatable datatable">
	<tr>
	<td>Name	</td>
	<td>Email	</td>
	<td>Main Category	</td>
	...
	<%
	List<UserCommunityInfomation> list=DataAceesLayer.getAllUserCommunityInfomation();
	for(UserCommunityInfomation communityInfomation2:list)
	{%>
		<tr style="color: navy;">
		<td><%=communityInfomation2.getFname()+"  "+communityInfomation2.getLname() %>	</td>
		<td><%=communityInfomation2.getEmail()%>	</td>
		<td><%=communityInfomation2.getCategoryName()%>	</td>
		<td><%=communityInfomation2.getSubCategoryName()%>	</td>
		<td><%=DataAceesLayer.calculateTotalRewars(communityInfomation2.getUid()) %>	</td>
		</tr>
	<%}%>
	</table>
