...
%>
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li><a
							...
							<li><a href="AddNewCategoryInExisting.jsp"><span	data-hover="insert category">Update Category</span></a></li>
							<li><a href="allUsers.jsp"><span	data-hover="insert category">All Users</span></a></li>
							<li><a href="performanveGraph.jsp"><span	data-hover="Performance Garph">Performance Graph</span></a></li>
	...
	<br>
	<center>
	<form action="NewCategoryInsertionController" method="post">
	<input type="text" name ="category" placeholder="enter main category" required><br><br>
	<input type="text" name ="subcategory" placeholder="enter sub category" required><br><br>
	<textarea rows="2" cols="50" name="desc" placeholder="Enter Your community Description" title="Enter Community Description"></textarea><br><br>
	<input type="submit" name="submit" value="insert New Category">
	</form>
	</center>
