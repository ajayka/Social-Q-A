			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li><a
							href="myProfile.jsp"><span
								data-hover="My Profile">My Profile</span></a></li>
						<li><a
							href="friendList.jsp"><span	data-hover="Friend List">Friends</span></a></li>
...
<center>
		...
		<form action="SearchQuestionController" method="post">
			<!-- <textarea rows="2" cols="50" name="question" placeholder="Search your question" title="Search question here"></textarea> -->
			<input class="text-css" style="width: 50%; height: 45px;" type="text" name="question" placeholder="Search your question" title="Search question here" required>
			<input type="hidden" name="uid"	value="<%=communityInfomation.getUid()%>"> 
			<input type="hidden" name="cid" value="<%=communityInfomation.getCid()%>">
			<input type="hidden" name="subid" value="<%=communityInfomation.getSubid()%>"><br><br>
			<input class="btn-style" style="height: 40px;" type="submit" name="submit" value="Submit">
			<input class="btn-style" style="height: 40px;" type="reset" value="Clear" >
		</form>
		
		<%-- <%
				for(PriviousQuestion ques:questionList)
		{%>
			<b style="color: navy; font-size: 30px;"><%=ques.getQuestion() %></b>
