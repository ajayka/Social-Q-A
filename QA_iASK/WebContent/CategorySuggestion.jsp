...
%>
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav">
						...
						<li><a
							...
							<li><a href="CategorySuggestion.jsp"><span data-hover="Category Suggestion">Category Suggestion(<%=DataAceesLayer.getSuggestCategoryCount() %>)</span></a></li>
	...
	<div>
	<%int count=1;
	List<Suggestion> list=DataAceesLayer.getSuggestCategory();
	for(Suggestion suggestion:list)
	{%>
	<form action="ApproveController" method="post">
		<%=count++ %>)<b style="color: navy;">Admin please add this category----><%=suggestion.getSugg() %></b>
		
		<input type="hidden" name="id" value="<%=suggestion.getId()%>">
