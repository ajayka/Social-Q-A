...
<!--header-->
	...
	<!--header-->
		<div class="banner-w3agile">
			<div class="container">
				<h3><a href="Home.jsp">Home</a> / <span>Mail send</span></h3>
			</div>
		</div>
	<br>
	<%
	...
	%>
	<br>
	<center><i><b style="color: navy;font-size: 30px">Mail Send Successful</b></i></center>
	
	<center><i><b style="color: navy;font-size: 20px"><%=msg %></b></i></center>
