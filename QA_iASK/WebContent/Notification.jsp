...
UserCommunityInfomation communityInfomation=
			DataAceesLayer.getUserCommunityInfomation(uid);
...
<!--header-->
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<nav class="link-effect-2" id="link-effect-2">
								<ul class="nav navbar-nav">
									...
									<li><a href="Notification.jsp"><span data-hover="Notification">Notification(<%=DataAceesLayer.getNotificationCount(uid) %>)</span></a></li>
	...
	<!--header-->
		<div class="banner-w3agile">
			<div class="container">
				<h3><a href="Home.jsp?uid=<%=uid %>">Home</a> / <span>Notification</span></h3>
			</div>
		</div>
	<br>
	<br>
    ...
    <%
   List<Notification> list= DataAceesLayer.getNotification(uid);
	for(Notification n:list){
		UserCommunityInfomation userInfomation=
				DataAceesLayer.getUserCommunityInfomation(n.getCuid());
	%>
		
<center>
		<a href="friendsProfile.jsp?uid=<%=userInfomation.getUid()%>">
		<i><b style="color: navy;font-size: 27px;"><%=userInfomation.getFname()+" "+userInfomation.getLname() %></b></i></a>	
		&nbsp;&nbsp;&nbsp;&nbsp;
		<b style="color:blue;font-size: 30px;">"<%=n.getPost()%>"</b><br>
